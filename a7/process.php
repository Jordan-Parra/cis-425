<?php
	// Build 3 single dimensional arrays for usernames, passords, and full names
	$usernames = array("deande", "japarra4", "nstanz");
	$passwords = array("redbull", "dennis", "bacon");
	$fullnames = array("Dennis A", "Jordan P", "Nathan S");
