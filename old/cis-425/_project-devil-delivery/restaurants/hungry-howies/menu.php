...
<!-- 
Project - Devil Delivery Hungry Howie's Menu Page
CIS 425
Fall 2014
Jordan Parra
-->
...
<html lang="en">
	<head>
		...
		<!-- Web Page Title -->
		<title>Hungry Howie's Menu</title>
		...
		<div id="content">
			<div id="content_wrapper" class="">
				...
				<div class="top_container">
					<?php
						//
						$query 	= "SELECT * FROM `dd_restaurants` WHERE id = '3'";
					...
					<div class="va_container0">
						<div class="va_container1">
							<div class="va_container2">
								<h1 class="">Hungry Howie's Pizza</h1>
							</div>
						</div>
					</div>
				</div>
				...
				<table>
					<?php
						$query 	= "SELECT * FROM `dd_menu_items` WHERE rest_id = '3'";
