...
<!-- 
Project - Devil Delivery Restaurants Page
CIS 425
Fall 2014
Jordan Parra
-->
...
<html lang="en">
	<head>
		...
		<link type="text/css" rel="stylesheet" href="../css/restaurants.css" />
	...
	<body>
		...
		<div id="content">
			<div id="content_wrapper">
				...
				<table>
					<?php
						$query 	= "SELECT * FROM `dd_restaurants`";
						$result	= mysqli_query($dbc, $query);
						
						while ($row	= mysqli_fetch_array($result))
						{
							echo	'<tr>
										<td><img class="image" alt="' . $row['image_alt_attribute'] . '" src="' . $row['image'] . '" /></td>
										<td><h2>' . $row['name'] . '</h2></td>
										<td><a class="button menu_button" href="' . $row['menu'] . '">View Menu &#10152;</a></td>
									 </tr>';
						}
					?>
				</table>
