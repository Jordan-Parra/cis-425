...
<!-- 
Project - Devil Delivery Gus's Pizza Menu Page
CIS 425
Fall 2014
Jordan Parra
-->
		...
		<div id="content">
			<div id="content_wrapper" class="">
				...
				<div class="top_container">
					<?php
						//
						$query 	= "SELECT * FROM `dd_restaurants` WHERE id = '4'";
					...
					<div class="va_container0">
						<div class="va_container1">
							<div class="va_container2">
								<h1 class="">Gus's New York Pizza</h1>
							</div>
						</div>
					</div>
				</div>
				...
				<table>
					<?php
						$query 	= "SELECT * FROM dd_menu_items WHERE rest_id = '4'";
						$result = mysqli_query($dbc, $query) or die("Error querying the database");
