...
<!-- 
Project - Devil Delivery Big Jimmy's Menu Page
CIS 425
Fall 2014
Jordan Parra
-->
		...
		<div id="content">
			<div id="content_wrapper" class="">
				...
				<div class="top_container">
					<?php
						//
						$query 	= "SELECT * FROM `dd_restaurants` WHERE id = '2'";
					...
					<div class="va_container0">
						<div class="va_container1">
							<div class="va_container2">
								<h1 class="">Big Jimmy's $5 Large Pizza</h1>
							</div>
						</div>
					</div>
				</div>
				...
				<table>
					<?php
						$query	= "SELECT * FROM `dd_menu_items` WHERE `rest_id` = '2'";
						$result = mysqli_query($dbc, $query) or die("Error querying the database for menu");
